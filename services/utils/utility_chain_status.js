...
/**
 * Check the status of utility chain services of platform
 *
 * @module services/utils/utility_chain_status
 */
...
/**
 * Constructor for utility chain service status
 *
 * @constructor
 */
const UtilityChainStatusKlass = function() {};

UtilityChainStatusKlass.prototype = {
  /**
   *
   * Perform
   *
  ...
  asyncPerform: async function() {
    const oThis = this,
      statusResponse = { chain: { utility: false } };
...
InstanceComposer.registerShadowableClass(UtilityChainStatusKlass, 'getUtilityChainStatusService');

module.exports = UtilityChainStatusKlass;
