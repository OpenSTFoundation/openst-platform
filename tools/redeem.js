...
const askStakingAmount = function(bigNumBalance) {
  return new Promise( function(resolve, reject) {
    console.log("Please mention the Simple Tokens to Redeem.");
    readlineInterface.prompt();
    const rlCallback = function(line) {
...
// approve(0)
// approve(value)
// allowance (check approve amount)
//
// openSTUtility.redeem(uuid, amountBT, nonce)
// fires RedemptionIntentDeclared
// and start listening for RedemptionIntentConfirmed
//
//
//
//   inter_comm listens RedemptionIntentDeclared
// on receive of RedemptionIntentDeclared inter_comm will run
// openSTValue.confirmRedemptionIntent(uuid,redeemer,redeemerNonce,amountUT,redemptionUnlockHeight,redemptionIntentHash)
// fires RedemptionIntentConfirmed
//
//
// redeem.js
// ----------------
//   On listen RedemptionIntentConfirmed
//
// openSTUtility.processRedeeming(redemptionIntentHash)
// openSTValue.processUnstaking(redemptionIntentHash)
