...
StPrimeKlass.prototype = {
   ...
   *
   */
  transfer: async function (senderAddr, senderPassphrase, recipient, amountInWei, tag, inAsync) {
    var oThis = this
      , txUUID = uuid.v4()
    ;
    ...
    const asyncTransfer = async function() {
      return web3RpcProvider.eth.personal.unlockAccount(senderAddr, senderPassphrase)
        .then(function(){
            return web3RpcProvider.eth.sendTransaction({from: senderAddr, to: recipient, value: bigNumAmount.toString(10),
