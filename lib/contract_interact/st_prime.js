...
const StPrimeKlass = function (contractAddress) {
  ...
  stPrimeContractObj = stPrimeContractObj || new (web3ProviderFactory.getProvider('utility', 'ws')).eth.Contract(stPrimeContractAbi);
...
StPrimeKlass.prototype = {
  ...
  getBalanceOf: function (owner) {
    ...
    return new Promise(function (onResolve, onReject) {
      ...
      (web3ProviderFactory.getProvider('utility', 'ws')).eth.getBalance(owner).then(function (balanceFromChain) {
  ...
  initialTransferToContract: async function (senderName, customOptions) {
    const oThis = this
      ...
      , stPrimeTotalSupplyInWei = web3ProviderFactory.getProvider('utility', 'ws').utils.toWei(coreConstants.OST_UTILITY_STPRIME_TOTAL_SUPPLY, "ether");
