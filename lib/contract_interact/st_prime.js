...
StPrimeKlass.prototype = {
  ...
  initialTransferToContract: async function(senderName, customOptions) {
    ...
    var options = {
      gasPrice: oThis.UTILITY_GAS_PRICE,
      value: stPrimeTotalSupplyInWei,
    ...
    const asyncTransfer = function() {
      ...
      return new Promise(function(onResolve, onReject) {
        ...
        web3ProviderFactory
          ...
          .eth.personal.unlockAccount(senderAddr, senderPassphrase)
          .then(function() {
  ...
  _validateBalance: function(owner, bigMinAmount) {
    ...
    return oThis.getBalanceOf(owner).then(function(response) {
