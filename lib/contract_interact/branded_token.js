...
const BrandedTokenKlass = function (memberObject) {
  ...
  this.currContract = new (web3ProviderFactory.getProvider('utility', 'ws')).eth.Contract(contractAbi, this._getBTAddress());
};
...
BrandedTokenKlass.prototype = {
  ...
  claim: async function (senderAddress, senderPassphrase, beneficiaryAddress) {
    ...
    const claimResponse = await contractInteractHelper.safeSendFromAddr(web3ProviderFactory.getProvider('utility', 'ws'), oThis._getBTAddress(), encodedABI,
  ...
  approve: async function (ownerAddress, ownerPassphrase, spenderAddress, value, inAsync) {
    ...
    if (inAsync) {
      ...
      const transactionHash = await contractInteractHelper.sendTxAsyncFromAddr(web3ProviderFactory.getProvider('utility', 'ws'), oThis._getBTAddress(), encodedABI,
  ...
  _callMethod: function (methodName, args) {
    ...
    return contractInteractHelper.call(web3ProviderFactory.getProvider('utility', 'ws'), btAddress, encodeABI, {}, transactionOutputs)
