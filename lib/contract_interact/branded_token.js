...
BrandedTokenContractInteractKlass.prototype = {
  ...
  getAllowance: function (owner, spender) {
    const oThis = this
      ...
      , isSpenderValid = contractInteractHelper.isAddressValid(spender)
    ;
  ...
  processMinting: function (memberObject, mintingIntentHash) {
    ...
    return contractInteractHelper.send(web3RpcProvider, btAddress, encodeABI,
  ...
  getUserPassphrase: function (address) {
    ...
    return contractInteractHelper.generateManagedKeyPassphrase(input1, input2, input3);
  },
  ...
  allowance: function (ownerAddress, spenderAddress) {
    ...
    return contractInteractHelper.call(
      web3RpcProvider,
      oThis._getBTAddress(),
      encodedABI,
      {},
  ...
  _initiateTransferInChain: function (transferParams, transactionObject, transactionLogger) {
    ...
    return contractInteractHelper.call(web3RpcProvider, btAddress, encodeABI, {from: senderAddr}, transactionOutputs)
      .then(function () {
