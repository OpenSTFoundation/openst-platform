...
BrandedTokenKlass.prototype = {
  ...
  transfer: async function (senderAddr, senderPassphrase, reservePassphrase, recipient, amountInWei) {
    ...
    const asyncTransfer = async function() {
      ...
      // Fund ST' if needed
      var fundStPrimeResponse = await oThis._fundSTPrimeIfNeeded(oThis._getMemberReserve(), reservePassphrase,
        senderAddr, transactionObject);
   ...
   * @ignore
   */
  _fundSTPrimeIfNeeded: async function (reserve, reservePassphrase, senderAddr, transactionObject) {
    ...
    // Transfer ST'
    return stPrime.transfer(reserve, reservePassphrase, senderAddr, stPrimeToTransfer, "GasRefill", false);
  },
