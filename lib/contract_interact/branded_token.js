...
BrandedTokenKlass.prototype = {
   ...
   *
   */
  transfer: async function (senderAddr, senderPassphrase, reservePassphrase, recipient, amountInWei) {
    const oThis = this
      , txUUID = uuid.v4();
    ...
    // // Fund ST' if needed
    // const fundStPrimeResponse = await oThis._fundSTPrimeIfNeeded(oThis._getMemberReserve(), reservePassphrase,
    //   senderAddr, transactionObject, txUUID);
    ...
    // }
      ...
      // Transfer branded tokens
      const transferTxHash = await contractInteractHelper.sendTxAsyncFromAddr(web3RpcProvider,  oThis._getBTAddress(),
        transactionObject.encodeABI(), senderAddr, senderPassphrase, txParams);
      ...
      openSTNotification.publish_event.perform(
        {
          ...
          message: {
            ...
            payload: {
              ...
              method: 'transfer',
              params: {args: [recipient, bigNumAmount.toString(10)], txParams: txParams},
    ...
    return Promise.resolve(responseHelper.successWithData({txUuid: txUUID, transaction_hash: transferTxHash}));
  },
  ...
  //  *
  //  * @param {string} reserve - Reserve address
  //  * @param {string} reservePassphrase - Reserve passphrase
  ...
  //  * @param {String} txUuid - uuid of the parent transaction
  //  *
  //  * @return {promise<result>}
  //  *
  //  * @ignore
  //  */
  // _fundSTPrimeIfNeeded: async function (reserve, reservePassphrase, senderAddr, transactionObject, txUuid) {
  ...
  //
  //   // Transfer ST'
  //   return stPrime.transfer(reserve, reservePassphrase, senderAddr, stPrimeToTransfer,
  //     {tag: 'GasRefill', inAsync: false, uuid: txUuid});
  // },
