  ...
  */
  ...
  _transferInChain: function ( transferParams, transactionObject ) {
    ...
    return helper.call(web3RpcProvider, btAddress, encodeABI, {from: senderAddr}, transactionOutputs)
      .then(_ => {
        console.log("UtilityToken._transferInChain CALL Successful");
        return helper.sendTxAsyncFromAddr(
          ...
          .then( transactionHash => {
            console.log("UtilityToken._transferInChain SEND Successful");
            return responseHelper.successWithData({
          ...
          .catch( reason => {
            console.log("UtilityToken._transferInChain SEND Failed!");
