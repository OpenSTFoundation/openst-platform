 ...
 *
 */
UtilityRegistrarKlass.prototype.registerBrandedToken = async function(
  senderAddress,
  senderPassphrase,
  registry,
  symbol,
  ...
  const encodedABI = oThis.utilityRegistrarContractObj.methods
 ...
 *
 */
UtilityRegistrarKlass.prototype.confirmStakingIntent = async function(
  senderAddress,
  senderPassphrase,
