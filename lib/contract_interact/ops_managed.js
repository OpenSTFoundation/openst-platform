...
OpsManagedKlass.prototype.getOpsAddress = async function() {
  ...
  const response = await contractInteractHelper.call(
    oThis.web3Provider,
...
OpsManagedKlass.prototype.setOpsAddress = async function(senderName, opsAddress, customOptions) {
  ...
  return contractInteractHelper.safeSend(oThis.web3Provider, oThis.contractAddress, encodedABI, senderName, options);
};
