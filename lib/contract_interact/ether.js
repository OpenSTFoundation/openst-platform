...
EtherKlass.prototype = {
  ...
  getBalanceOf: function (owner) {
    ...
    return web3ProviderFactory.getProvider('value', 'ws').eth.getBalance(owner)
  ...
  transfer: async function (senderAddr, senderPassphrase, recipientAddr, amountInWei, options) {
    ...
    const asyncTransfer = function () {
      ...
      return new Promise(function (onResolve, onReject) {
        ...
        web3ProviderFactory.getProvider('value', 'ws').eth.personal.unlockAccount(senderAddr, senderPassphrase)
          .then(function () {
