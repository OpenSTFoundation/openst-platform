...
const rootPrefix = '../..'
  ...
  , web3LogsDecoder = require(rootPrefix+'/lib/web3/logs_decoder')
;
    ...
    return new Promise (function(onResolve, onReject) {
      ...
      var handleResponse = function (response) {
        if (response) {
          ...
          const web3LogsDecoderResult = web3LogsDecoder.perform(response)
            , web3LogsDecoderResultData = web3LogsDecoderResult.data;
          if (web3LogsDecoderResult.isSuccess()) {
            onResolve(web3LogsDecoderResultData);
          } else {
            onReject(web3LogsDecoderResultData);
          }
        } else {
