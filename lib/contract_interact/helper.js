...
const helper = {
  ...
  generateManagedKeyPassphrase: function (...arg) {
    //We will have some also here to generate the passphrase.
  ...
  generateManagedKeyPassphraseFor: function ( managedAddress ) {
    //We will do some stuff here to figure out 
    //all the inputs required to generate passphrase.
    var input1   = ""
        ,input2  = ""
        ,input3  = ""
    ;
    return generateManagedKeyPassphrase(input1, input2, input3);
  }
