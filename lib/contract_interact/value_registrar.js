...
ValueRegistrarKlass.prototype.registerUtilityToken = async function (senderAddress, senderPassphrase,
  ...
  const encodedABI = oThis.valueRegistrarContractObj.methods.registerUtilityToken(registry, symbol, name, conversionRate,
...
ValueRegistrarKlass.prototype.confirmRedemptionIntent = function (senderAddress, senderPassphrase,
  ...
  const encodedABI = oThis.valueRegistrarContractObj.methods.confirmRedemptionIntent(registryContractAddr, uuid,
