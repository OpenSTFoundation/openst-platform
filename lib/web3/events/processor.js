 ...
 * Event Processor
 *
 * @param {object} eventObj - this is the event object
 * @param {callback} processor - this is the processor function
 *
 * @constructor
 */
const EventProcessor = function(eventObj, processor) {
...
EventProcessor.prototype = {
   ...
   * TODO: Time should be dynamic and check if transaction persist in block, else wait again.
   */
  eventProcessingDelay: 10000,
  ...
  scheduleProcessing: function() {
    ...
    if (oThis.isScheduled || !oThis.isValid()) {
      logger.warn(
        'EventProcessor :: scheduleProcessing :: Processing is already scheduled or not valid.',
        oThis.getEventDescription()
      );
      return false;
    }
