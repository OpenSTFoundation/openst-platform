...
const coreConstants = require('../config/core_constants')
      ,VC_RPC = coreConstants.OST_GETH_VALUE_CHAIN_RPC_PROVIDER
      ,VC_WS = coreConstants.OST_GETH_VALUE_CHAIN_WS_PROVIDER
      ,UC_RPC = coreConstants.OST_GETH_UTILITY_CHAIN_RPC_PROVIDER
      ,UC_WS = coreConstants.OST_GETH_UTILITY_CHAIN_RPC_PROVIDER
;

console.log("VC_RPC", VC_RPC);
