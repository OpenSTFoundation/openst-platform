...
const mustache = require('mustache')
  , fs = require('fs')
  , Path = require('path')
 , openStEnvVarsSourceFile = '../test/set_env_vars.sh';
...
const addressTemplate = "export OST_FOUNDATION_ADDR='{{ost_foundation_address}}'\n" +
  ...
  "export OST_VALUE_DEPLOYER_ADDR='{{ost_value_deployer_address}}'\n"+
  "export OST_UTILITY_DEPLOYER_ADDR='{{ost_utility_deployer_address}}'";
...
const deployScript2AddressesTemplate = "export OST_UTILITY_REGISTRAR_CONTRACT_ADDR='{{ost_utility_registrar_contract_addr}}'\n" +
  ...
  "export OST_STPRIME_CONTRACT_ADDR='{{ost_stprime_contract_addr}}'";
