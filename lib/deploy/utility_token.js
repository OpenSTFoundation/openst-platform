...
const performer = async function(member) {
  ...
  var txReceipt = await stakingContractInteract.registerUtilityToken(member.Symbol, member.Name, member.Decimals, member.ConversionRate, member.ChainId, member.Reserve, deployerName);
  console.log(txReceipt);
