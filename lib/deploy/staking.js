...
const performer = async function() {
  ...
  var txObj = currContract.methods.setAdminAddress(registrarAddress);
  var transactionReceipt = await contractHelper.safeSend(web3RpcProvider, txObj, deployerName,
    {
